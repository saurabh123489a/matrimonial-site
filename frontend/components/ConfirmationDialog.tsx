      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl max-w-md w-full animate-scale-in">
        <div className="p-6">
          ...
          <div className="flex gap-3 justify-end">
            <button
              onClick={onCancel}
              className="px-4 py-2 border border-gray-300 dark:border-slate-600 text-gray-700 dark:text-slate-300 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors font-medium"
            >
              {cancelLabel}
            </button>
            <button
