...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors">
      ...
      <div className="bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 transition-colors">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          <div className="text-center mb-8">
            <h2 className="text-2xl sm:text-3xl font-light text-gray-900 mb-2">Find Your Perfect Match</h2>
            <p className="text-gray-600 text-sm">Search from thousands of verified profiles</p>
          </div>
      ...
      <div className="bg-gradient-to-br from-pink-50 via-red-50 to-pink-100 dark:from-gray-800 dark:via-gray-800 dark:to-gray-900 border-t border-b border-pink-100 dark:border-gray-700 transition-colors">
